# nf-core/methylong: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/methylong/usage](https://nf-co.re/methylong/usage)
...
```bash
nextflow run nf-core/methylong --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
